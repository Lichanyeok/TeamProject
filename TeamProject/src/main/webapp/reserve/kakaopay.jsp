...
<%
	...
	bean = dao.paymentInfo(id);

	String email = bean.getEmail();
	String name = bean.getName();
	String mobile = bean.getMobile();
	String address = bean.getAddress() + bean.getAddressDetail();
...
<body>
    ...
    $(function(){
        ...
        IMP.init('imp37849717'); // 'iamport' 대신 부여받은 "가맹점 식별코드"를 사용
        var msg;
        ...
        IMP.request_pay({
            ...
            if ( rsp.success ) {
                ...
                //실패시 이동할 페이지
                location.href="/TeamProject/reserve/pay_form.jsp";
                alert(msg);
            }
        });
