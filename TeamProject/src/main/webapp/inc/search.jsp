...
#placesList .item .markerbg {float:left;position:absolute;width:36px; height:37px;margin:0px;background:url(https://t1.daumcdn.net/localimg/localimages/07/mapapidoc/marker_number_blue.png) no-repeat;}
