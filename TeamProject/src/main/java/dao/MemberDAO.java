...
public class MemberDAO {
    ...
    public MemberBean selectArticle(String pass) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                article.setAddressDetail(rs.getString("address_detail"));
    ...
    public int managementMember(MemberBean member) {
        ...
        try {
            String sql = "UPDATE project_member SET name=?,nickname=?,pass=?,mobile=?,age=?,email=?,address=?, address_detail=? WHERE id=?";
            pstmt = con.prepareStatement(sql);
    ...
    public ArrayList<MemberBean> getMemberDetail(String id, String pass) {
        ...
        MemberBean bean = null;
        try {
            String sql = "SELECT * FROM project_member WHERE id=? AND pass = ?";
            pstmt = con.prepareStatement(sql);
            pstmt.setString(1, id);
