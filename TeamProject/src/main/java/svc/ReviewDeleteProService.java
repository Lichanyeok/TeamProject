...
public class ReviewDeleteProService {
	...
	public Boolean isArticleWrite(String rev_name, String rev_pass) {
		System.out.println("ReviewDeleteProService - isArticleWrite()");
	...
	public boolean removeArticle(int rev_num) {
		...
		int modifyCount = dao.deleteArticle(rev_num);
		...
		System.out.println("Service_isDeleteSuccess : " + isDeleteSuccess);
